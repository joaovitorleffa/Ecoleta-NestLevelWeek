...
const CreatePoint = () => {
  ...
  }, [selectedUf]); //executa quando esse estado mudar
  ...
  function handleSelectItem(id: number) {
    const alreadySelected = selectedItems.findIndex(item => item === id) //retorna > 0 se o item ja estiver no array caso contrário retorna -1
