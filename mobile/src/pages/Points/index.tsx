...
const Points = () => {
  ...
  const [initialPositon, setInitalPosition] = useState<[number, number]>([0, 0]);
  ...
  // locazição do usuário
  useEffect(() => {
    async function loadPosition() {
      // retorna o satatus que o usuário deu (Sim/Não)
      ...
      // retorn a localização do usuário
  ...
  }, [selectedItems]); // sempre que o selectedItems mudar ele executa o useEffect novamente
